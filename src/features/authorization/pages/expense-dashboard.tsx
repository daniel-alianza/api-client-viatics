      ...
      <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-50 to-gray-100">
        <header className="sticky top-0 z-10 border-b bg-white/80 backdrop-blur-md shadow-sm">
          <div className="container flex h-16 items-center justify-between">
            <motion.h1
              ...
              className="text-xl font-bold text-[#02082C]"
            >
        ...
        <main className="flex-1 p-6">
          <div className="container mx-auto">
            ...
            >
              <h2 className="mb-4 text-2xl font-bold text-white">Travel Expense Requests</h2>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}>
              <ExpenseTable searchQuery={searchQuery} statusFilter={statusFilter} />
            </motion.div>
          </div>
        </main>
      </div>
